...
with
    real        : type like NUMBER.number
    angle       : type like ANGLE.angle


module COMPLEX[real, angle] with
// ----------------------------------------------------------------------------
...
//  found in the implementation, e.g. converting imaginary to cartesian, etc.
    ...
    X:complex / Y:complex       as divide_error         when Y = 0
    ...
    ln          Z:polar         as logarithm_error      when Z.Arg = 0
    ...
    to write    Z:complex
    to read     Z:out complex

    // Errors
    type divide_error           like NUMBER.numeric_error
    type logarithm_error        like NUMBER.numeric_error
...
//   This makes it easier to instantiate the generic modules
    ...
    type complex[real, angle]   is COMPLEX[real, angle].complex
    type complex[real]          is COMPLEX[real].complex
