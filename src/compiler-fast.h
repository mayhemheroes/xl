...
public:
    ...
    Tree_g              returnType;     // The return type for the expression
...
public:
    ...
    Scope_g     declContext;    // Symbols in which the rewrite was declared
    Context     argContext;     // Symbols where we declare arguments
    Tree_g      test;           // Tree we test
    Tree_g      defined;        // Tree beind defined, e.g. 'sin' in 'sin X'
